...
QString Root::html() const
{
    ...
    result.append(indentation() + QLatin1String("<link rel=\"stylesheet\" type=\"text/css\" href=\"fancybox/jquery.fancybox-1.3.4.css\" media=\"screen\"/>\n"));
    ...
    result.append(indentation() + QLatin1String("<script type=\"text/javascript\" src=\"jquery-1.6.min.js\"></script>\n"));
    result.append(indentation() + QLatin1String("<script type=\"text/javascript\" src=\"fancybox/jquery.fancybox-1.3.4.pack.js\"></script>\n"));
